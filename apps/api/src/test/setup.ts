...
const TEST_DATABASE_URL =
  process.env.TEST_DATABASE_URL || 'postgresql://gtsd:gtsd_dev_password@localhost:5434/gtsd_test';
...
// Twilio test configuration (must start with AC for validation)
process.env.TWILIO_ACCOUNT_SID =
  process.env.TWILIO_ACCOUNT_SID || 'ACtest_account_sid_for_testing_purposes';
